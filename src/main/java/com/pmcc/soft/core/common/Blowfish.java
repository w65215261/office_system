...
public class Blowfish {
	...
	public static void main(String[] args) {
		Blowfish blowfish = new Blowfish("ym27DXn70tgCL5c");
		String enStr = blowfish.encrypt("123456");
		Blowfish blowfish2 = new Blowfish("ym27DXn70tgCL5c");
		String  st = blowfish.decrypt("c09e91b8d03f5eb84fb7423d5d058257dd4e62b1b62881ca");
