...
public class NewsInfoController {
    ...
    @ResponseBody
    public Map<String, Object> query(NewsInfo ni, HttpServletRequest request,HttpSession session) throws UnsupportedEncodingException{
...
//            content = new String(content.getBytes("ISO-8859-1"),"UTF-8");
        ...
        ni.setOrgId(personManage.getCompanyId());
