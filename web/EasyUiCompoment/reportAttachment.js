...
function uploadFile14() {
    ...
    xhr.open("POST", "/attachment/upload.do?uuid=" + coid+"&businessModel=0&businessType=0");
    xhr.send(fd);
...
function uploadComplete14(evt) {
    ...
    if(res != null && res != ""){
        ...
        $.ajax({
            type: "POST",
            url: '/summarizeReport/queryDetail.do',
            data: {
                reportId: res
            },
            success: function (data) {
                ...
                document.getElementById("files14").style.height=data.sas.length*45+"px";
            }
        })
    }
}
