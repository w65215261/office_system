    	...
    	// 文件上传
      	function uploadFile() {
         	...
         	xhr.addEventListener("error", uploadFailed, false);
          	...
          	// 修改页面
          	if(hid != null){
          		xhr.open("POST", "/attachment/upload.do?uuid=" + hid.value);
          	}else{
          		// 新增页面
          		if(uuid != null && uuid != ""){
    	          	xhr.open("POST", "/attachment/upload.do?uuid=" + uuid);
              	}else{
    	          	xhr.open("POST", "/attachment/upload.do");
              	}
          	}
         	xhr.send(fd);
    		        	...
    		        	$.ajax({
    		       	          ...
    		       	          success:function(data){
    		       	        	  if(data == '1'){
    		       	        		...
    		       	        		$('#mc').datagrid('reload',{contractOid:uuid});
    		       	        	  }else{
