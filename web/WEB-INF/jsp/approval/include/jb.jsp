...
<tr>
  ...
  <th data-hide="phone">加班时长</th>
  <th data-hide="phone">加班核算方式</th>
  <th data-hide="phone">加班原因</th>
  <th data-hide="phone">是否法定假日</th>
  ...
  var pagefunction = function() {
    ...
    $('#detailsButton').click( function () {
      ...
      if(table.rows('.selected').data().length!=1){
        ...
        $('#home').empty();
        loadURL("/approval/get.do?approvalHeadId="+approvalHeadId+"&approvalType="+approvalType+"&queryFlag="+queryFlag+"&taskId="+taskId,$('#home'));
      }
    });
  }
