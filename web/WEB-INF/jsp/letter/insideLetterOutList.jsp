...
<table id="inbox-table"  class="table table-striped table-hover">
    ...
    <c:forEach items="${letterOutList}" var="d">
            <tr  id="${d.id}" >
                <td class="inbox-table-icon">
                    <div class="checkbox">
                        <label>
...
<script>
    ...
    $(".inbox-page-a").click(function() {
        loadURL('/message/queryOutbox.do?flag=2&page=${currentPage-1}', $('#inbox-content > .table-wrap'))
    });
    $(".inbox-page-b").click(function() {
        var  num  = $(this).attr("id");
        loadURL('/message/queryOutbox.do?flag=2&page='+num, $('#inbox-content > .table-wrap'))
    });
    ...
    $(".deleteStatusButton").click(function() {
        ...
        if (str.length >2) {
            $.ajax({
                url: "/message/deleteStatus.do?flag=2",
                type: "get",
                data: {"stri": str}
