                ...
                <h1>
                   ${dlnoticemanage.title }<br />
                    ...
                    <span>
                        ...
                        ${dlnoticemanage.createtime}&nbsp;&nbsp;阅读(<font class="nums_yd"></font>)&nbsp;&nbsp;评论(<font class="nums_pl"></font>)
                    </span>
                </h1>
             
            </div>
            <div class="gg_content">
                ${dlnoticemanage.content }
            </div>
            <div class="gg_files">
                <font style="font-weight: bold;">
                    附件：
                ...
                <ul>
                    <li>
                        <a class="fileDownload" href="../../noticeManage/downFile.do?id=${dlnoticemanage.id }">${dlnoticfilename } </a>
<!--                         &nbsp;&nbsp;(下载 -->
<!--                         <span class="count"> -->
<!--                             14 -->
<!--                         </span> 次) -->
