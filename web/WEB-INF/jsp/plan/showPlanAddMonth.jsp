    ...
    <tr>
      <td>
        ...
        <div style="width: auto;float: left; "id="divColor">
          ...
          <input id="timeType" type="hidden" value="1">
          <input id="showFlag" type="hidden" value="show0">
        </div>
      </td>
    </tr>
  </table>
        ...
        <fieldset>
          <section>
            <p class="input-group">
              ...
              <input type="text" class="form-control" id="taskName" name="taskName" onblur="checkTaskName()"
                     placeholder="请输入计划名称"/>
            </p>
          </section>
          <!--折叠控件start-->
