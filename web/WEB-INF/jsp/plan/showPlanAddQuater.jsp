    ...
    <tr>
      <td>
        <div style="width: auto;float: left; "id="divColor">
            <div style='border-right:dashed #808080 1px;width: 40px;text-align: center;float: left;' ><span class='week'   id='c0' style='color: #ff0000' onclick='chooseYearD()'>年度</span></div>
            <div style='border-right:dashed #808080 1px;width: 100px;text-align: center;float: left' ><span class='week'  id='c1' onclick='chooseQuarter(1)'>第1季度</span></div>
            <div style='border-right:dashed #808080 1px;width: 100px;text-align: center;float: left' ><span class='week'  id='c2'  onclick='chooseQuarter(2)'>第2季度</span></div>
            <div style='border-right:dashed #808080 1px;width: 100px;text-align: center;float: left' ><span class='week'  id='c3'  onclick='chooseQuarter(3)'>第3季度</span></div>
            <div style='width: 100px;text-align: center;float: left' ><span class='week'  id='c4' onclick='chooseQuarter(4)'>第4季度</span>
              <input type='hidden' id='quarter'>
              <input type='hidden' id='timeType' value='3'><input type='hidden' id='showFlag' value='show3'>
    ...
    <fieldset>
      ...
      <section>
        <div class="row">
          ...
          <section class="col col-6">
            <label class="input"> <i class="icon-append fa fa-calendar"></i>
              <input type="text" name="endTime" id="endTime2" placeholder="选择结束日期" onchange="updEndTime()">
            </label>
          </section>
          <section class="col col-6">
