...
<div class="widget-body" style="width: 910px; height: auto ">
    ...
    <ul id="myTab1" class="nav nav-tabs bordered">
        <li class="active">
            <a href="#s1" data-toggle="tab">${totalRecord}个正在进行中的s</a>
        </li>
        <li>
            <a href="#s2" onclick="showProductRelaStatus()"  data-toggle="tab">${totalRecord1}个已完成的</a>
        </li>
    </ul>
    <div style="width: 910px; height: auto "id="myTabContent1" class="tab-content padding-10">
        <div class="tab-pane fade in active" id="s1">
            <div style="width: 910px;text-align: center;height: 260px">
                <c:forEach items="${projectRelaList}" var="dd">
