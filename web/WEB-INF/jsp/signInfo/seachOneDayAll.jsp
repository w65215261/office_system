    ...
    <div>
        <table id="user" class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <td style="min-width:80px;"><span style="display: block;width: 140px">签到时间</span> </td>
                <td style="min-width:80px;"><span style="display: block;width: 140px">签到地点</span> </td>
                    ...
                    <tr>
                        <c:forEach items="${lists}" var="l">
                            ...
                            <td>${orgCname}</td>
                            <td>${duty}</td>
                            <td><fmt:formatDate value="${l.signTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
                            <td>${l.signAddress}</td>
                            </tr>
                        </c:forEach>
...
<script>
    ...
    $(".inbox-page-a").click(function() {
        ...
        loadURL("/signInfo/queryOneDayByPerson.do?startTime="+startTime+"&endTime="+endTime+"&personId="+personId+"&page="+${currentPage-1}, $('#s1'));
    });
    $(".inbox-page-b").click(function() {
        ...
        loadURL("/signInfo/queryOneDayByPerson.do?startTime="+startTime+"&endTime="+endTime+"&personId="+personId+"&page="+num, $('#s1'));
    });
