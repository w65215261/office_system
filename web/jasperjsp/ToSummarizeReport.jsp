                      ...
                      case 1: 
                         {
                    	   filename = "log";
                    	   filecname = "人员日报";
                           parameters.put("sDate", DateUtil.StringToDate(request.getParameter("startTime")+ " 00:00:00", "yyyy-MM-dd HH:mm:ss"));
                           parameters.put("eDate", DateUtil.StringToDate(request.getParameter("endTime") + " 23:59:59", "yyyy-MM-dd HH:mm:ss"));
                    	   parameters.put("PERSON_SQL", " AND a.RPT_PERSON_ID = '" + request.getParameter("personId") + "'");
                             parameters.put("ORG_SQL", " AND  1 = 1");
                             System.out.println(parameters.get("PERSON_SQL"));
                    	   break;
                         }
                        case 2:
                        {
                            ...
                            parameters.put("sDate", DateUtil.StringToDate(request.getParameter("startTime")+ " 00:00:00", "yyyy-MM-dd HH:mm:ss"));
                            parameters.put("eDate", DateUtil.StringToDate(request.getParameter("endTime")+ " 23:59:59", "yyyy-MM-dd HH:mm:ss"));
//                            parameters.put("ORG_CODE", request.getParameter("Like"));
                            parameters.put("ORG_SQL", " AND a.ORGCODE LIKE '" + request.getParameter("orgCode") + "%'");
                            parameters.put("PERSON_SQL", " AND  1 = 1");
                            System.out.println(parameters.get("ORG_SQL"));
                            //parameters.put("SUBREPORT_DIR", request.getSession().getServletContext().getRealPath("/")+"jasper/" );
                            break;
                        }
                default : {}
            }
