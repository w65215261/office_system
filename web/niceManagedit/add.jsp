	...
	<div data-options="fit:true" >
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
			...
			<tr>
				 <td>
             <div class="file-box"> 
						上传：<input type='text' name='textfield' id='textfield' class='txt' value="${dlsoftversion.downloadurl}"/> 
			 ...
			 <tr>
				<td>
					<div align="center"; style="height:400px; overflow:auto;">
						<script id="editor"  type="text/plain" style="width: 970px; height: 350px;"></script>
					</div>
